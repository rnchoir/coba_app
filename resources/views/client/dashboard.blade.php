...
<div class="row">
    <div class="col-lg-3 col-md-6 single-blog">
        <div class="single-service">
            <div class="thumb">
                <img class="img-fluid" src="{{url('img/b1.jpg')}}" alt="">
            </div>
            ...
            <p>
                Merupaka anjfhalsfosanfsafoifoasjfiasans fuasfijsf8asf aksjfasfajksfjasuas
            </p>
            <div class="meta-bottom d-flex justify-content-between">
                <a href="#" class="text-uppercase primary-btn">Pesan Tiket</a>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 single-blog">
